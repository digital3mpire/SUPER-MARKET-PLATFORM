<head>
    ...
    -->
    <link rel="stylesheet" href="<?php echo base_url('00_css/materialize.min.css'); ?>">
    ...
    <link rel="stylesheet" href="<?php echo base_url('00_css/responsiveslides.css'); ?>">


    <script src="<?php echo base_url('00_js/jquery-3.2.1.min.js'); ?>"></script>
    <script src="<?php echo base_url('00_js/materialize.min.js'); ?>"></script>
    <script src="<?php echo base_url('00_js/responsiveslides.min.js'); ?>"></script>
